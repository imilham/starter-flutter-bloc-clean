...
mixin _$NotificationModel {
  ...
  int get hashCode => Object.hash(
      runtimeType, id, uuid, title, message, sentAt, readAt, createdAt);

  @override
  String toString() {
    return 'NotificationModel(id: $id, uuid: $uuid, title: $title, message: $message, sentAt: $sentAt, readAt: $readAt, createdAt: $createdAt)';
  }
}
...
extension NotificationModelPatterns on NotificationModel {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(int id, String uuid, String title, String message,
            String? sentAt, String? readAt, String? createdAt)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _NotificationModel() when $default != null:
        return $default(_that.id, _that.uuid, _that.title, _that.message,
            _that.sentAt, _that.readAt, _that.createdAt);
      case _:
        return orElse();
    }
  }
